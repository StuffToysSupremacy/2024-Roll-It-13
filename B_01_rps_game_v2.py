...
# checks fro an integer more than 0 (allows <enter>)
...
def rps_compare(user, comp):
    # If user the user and the computer choice is the same, it's a tie
    if user == comp:
        round_result = "tie"

    # There are three ways to wim
...
while rounds_played < num_rounds:
    ...
    # Set up rounds feedback and output it user
